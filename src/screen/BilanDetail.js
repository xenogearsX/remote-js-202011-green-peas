                ...
                <h3>
                    ...
                    <div className="textVulg">
                          ...
                          <span className='nbjours'>{(this.props.score.toFixed(0))*2}</span>  jours d'éclairage d'1 ampoule</p>
                            ...
                            <div className='road2'>______________________<span className="chicken">🌼</span>___________________<span className="chicken">🌼🌻</span>______________________________________<span className="chicken">🌻</span>________________<span className="chicken">🌻</span>___________________________<span className="chicken">🌼🌻</span>_______<span className="chicken">🌻</span>________________<span className="chicken">🌻</span>__</div>
                            </div>
                            </div>
