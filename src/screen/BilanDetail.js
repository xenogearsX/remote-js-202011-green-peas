            ...
            <div className="">
                ...
                <h3>
                    ...
                    <section className='info'>
                            ...
                            <div className='road2'>_______<span className="chicken">🌼</span>_______________<span className="chicken">🌼🌻</span>__________________<span className="chicken">🌻</span>_____________<span className="chicken">🌻</span>_______________<span className="chicken">🌼🌻</span>_______<span className="chicken">🌻</span>_____________<span className="chicken">🌻</span>__</div>
                            </div>
                            </div>
