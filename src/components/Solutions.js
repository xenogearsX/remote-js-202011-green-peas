...
const solutions = [
  {
    ...
    titre: "les AMAP",
    description: "Une AMAP (Association pour le Maintien de l'Agriculture Paysanne) est un partenariat entre un groupe de consommateurs et une exploitation locale. L'objectif est de préserver l'existence d'une agriculture de proximité, durable, saine et juste",
    photo: `${amap}`,
...

  {
    ...
    titre: "Jardin",
    description: "Si possible, jardine un bout de ton terrain selon les principes de la permaculture, une méthode qui vise à produire des fruits et légumes tout en recréant des écosystèmes respectueux de la biodiversité ",
    photo: `${perma}`, 
...

  {
    ...
    description: "Grâce à des plateformes comme MiiMOSA, donne du pouvoir à ton argent en investissant dans des projets de maraîchage, viticulture, élevage etc... et finance l'agriculture & alimentation de demain",
    photo: `${miimosa}`,
