...
const food = [
  ...
  { nom: "Lait 2e âge, poudre soluble (préparation de suite)", ef: "1.56" },
  ...
  { nom: "Pomme de terre, purée, avec lait et beurre, non salée", ef: "0.20" },
  {
    nom:
  ...
  { nom: "Pomme de terre sautée/poêlée à la graisse de canard", ef: "0.07" },
  ...
  { nom: "Aligot (purée de pomme de terre à la tomme fraîche)", ef: "0.37" },
  ...
  { nom: "Pain blanc maison (avec farine pour machine à pain)", ef: "0.13" },
  {
  ...
  { nom: "Mousse de foie de porc supérieure ou Crème de foie", ef: "0.77" },
  ...
  { nom: "Blé dur précuit, grains entiers, cuisiné, à poêler", ef: "0.06" },
  ...
  { nom: "Farine de blé tendre ou froment avec levure incorporée", ef: "0.09" },
  { nom: "Farine de blé tendre ou froment T45 (pour pâtisserie)", ef: "0.09" },
  ...
  { nom: "Calmar ou Calamar ou encornet, à la romaine (beignet)", ef: "0.88" },
  ...
  { nom: "Calmar ou calamar ou encornet, bouilli/cuit à l'eau", ef: "1.09" },
  ...
  { nom: "Pecten d'Amérique ou Peigne du canada, noix, crue", ef: "1.60" },
  ...
  { nom: "Moules farcies (matière grasse, persillade…), crues", ef: "0.37" },
  {
  ...
  { nom: "Sauce vinaigrette (50 à 75% d'huile), préemballée", ef: "0.50" },
  ...
  { nom: "Sauce basquaise ou Sauce aux poivrons, préemballée", ef: "0.24" },
  ...
  { nom: "Sauce au fromage pour risotto ou pâtes, préemballée", ef: "0.40" },
  ...
  { nom: "Sauce au poivre, condimentaire, froide, préemballée", ef: "0.30" },
  {
  ...
  { nom: "Fromage fondu en portions ou en cubes environ 20% MG", ef: "0.50" },
  {
    nom:
  ...
  { nom: "Fromage de chèvre bûche, allégé en matière grasse", ef: "0.95" },
  {
    nom:
  ...
  { nom: "Fruit de la passion ou maracudja, pulpe et pépins, cru", ef: "0.12" },
  ...
  { nom: "Dessert lacté infantile nature sucré ou aux fruits", ef: "0.22" },
  {
  ...
  { nom: "Ananas au sirop et jus d'ananas, appertisé, égoutté", ef: "0.24" },
  {
  ...
  { nom: "Mélange apéritif de graines salées et raisins secs", ef: "0.91" },
  ...
  { nom: "Matière grasse végétale ou margarine, 80% MG, doux", ef: "0.44" },
  {
  ...
  { nom: "Huile combinée, mélange d'huile d'olive et de graines", ef: "0.54" },
  ...
  { nom: "Boisson au thé, aromatisée, sucrée, avec édulcorants", ef: "0.09" },
  ...
  { nom: "Café expresso, non instantané, non sucré, prêt à boire", ef: "0.13" },
  { nom: "Café décaféiné, instantané, non sucré, prêt à boire", ef: "0.30" },
  ...
  { nom: "Poudre cacaotée ou au chocolat pour boisson, sucrée", ef: "1.70" },
  {
    nom:
  ...
  { nom: "Café au lait ou cappuccino au chocolat, poudre soluble", ef: "1.14" },
  {
    nom:
  ...
  { nom: "Boisson plate aux fruits (10 à 50% de jus), sucrée", ef: "0.08" },
  {
    nom:
  ...
  { nom: "Boisson énergisante, non sucrée, avec édulcorants", ef: "0.06" },
  ...
  { nom: "Crème de lait, 15 à 20% MG, légère, semi-épaisse, UHT", ef: "0.34" },
  {
  ...
  { nom: "Yaourt, lait fermenté ou spécialité laitière, nature", ef: "0.24" },
  {
  ...
  { nom: "Fromage frais type petit suisse, aux fruits, 2-3% MG", ef: "0.26" },
  {
    nom:
  ...
  { nom: "Fromage frais type petit suisse, nature, 4% MG environ", ef: "0.34" },
  {
  ...
  { nom: "Lait gélifié aromatisé, nappé caramel, rayon frais", ef: "0.24" },
  ...
  { nom: "Cheesecake ou Gâteau au fromage frais, rayon frais", ef: "0.47" },
  ...
  { nom: "Pois mange-tout ou pois gourmand, bouilli/cuit à l'eau", ef: "0.20" },
  ...
  { nom: "Plat légumes, avec féculent et lait/crème, dès 12 mois", ef: "0.16" },
  { nom: "Soupe pour bébé légumes et pomme de terre", ef: "0.08" },
  { nom: "Soupe pour bébé légumes, céréales et lait", ef: "0.09" },
  { nom: "Plat légumes, avec féculent et lait/crème, dès 18 mois", ef: "0.16" },
  ...
  { nom: "Wakamé (Undaria pinnatifida), séchée ou déshydratée", ef: "1.25" },
  ...
  { nom: "Ao-nori (Enteromorpha sp.), séchée ou déshydratée", ef: "1.25" },
  {
    nom:
  ...
  { nom: "Agneau, selle, partie maigre, rôtie/cuite au four", ef: "6.09" },
  ...
  { nom: "Canelé", ef: "0.27" },
  { nom: "Macaron moelleux fourré à la confiture ou à la crème", ef: "0.90" },
  ...
  { nom: "Gâteau de semoule aux raisins et caramel, rayon frais", ef: "0.18" },
  ...
  { nom: "Crêpe, nature, préemballée, rayon température ambiante", ef: "0.23" },
  ...
  { nom: "Biscuit sec à teneur garantie en vitamines et minéraux", ef: "0.45" },
  ...
  { nom: "Biscuit sec pour petit déjeuner, allégé en sucres", ef: "0.45" },
  ...
  { nom: "Florentin (biscuit sec sucré chocolaté aux amandes)", ef: "0.45" },
  ...
  { nom: 'Goûter sec fourré ("sandwiché") parfum lait ou vanille', ef: "0.62" },
  ...
  { nom: "Biscuit sec type langue de chat ou cigarette russe", ef: "0.54" },
  ...
  { nom: "Génoise sèche fourrée aux fruits et nappée de chocolat", ef: "0.42" },
  ...
  { nom: "Poisson blanc à la florentine (sauce aux épinards)", ef: "1.46" },
  {
    nom: "Poisson blanc à la marinière (sauce aux oignons, vin blanc, moules)",
    ef: "1.21",
  },
  { nom: "Poisson blanc à la sauce moutarde", ef: "1.46" },
  { nom: "Poisson blanc à la parisienne (sauce aux champignons)", ef: "1.57" },
  ...
  { nom: "Spécialité chinoise ou bouchées à la vapeur, cuite", ef: "0.37" },
  ...
  { nom: "Riste d'aubergines (aubergines, tomates, oignons)", ef: "0.28" },
  { nom: "Pâtes en sauce aux fromages (spaghetti, tagliatelles…)", ef: "0.37" },
  ...
  { nom: "Palet ou galette de légumes, préfrit, surgelé, cuit", ef: "0.19" },
  ...
  { nom: "Bouchée à la reine, à la viande/volaille/quenelle", ef: "0.39" },
  ...
  { nom: "Beignet de viande, volaille ou poisson, fait maison", ef: "0.85" },
  {
  ...
  { nom: "Yakitori (brochettes japonaises grillées en sauce)", ef: "0.99" },
  { nom: "Brochette de porc, crue", ef: "0.99" },
  { nom: "Pastilla au poulet", ef: "0.72" },
  { nom: "Pizza aux lardons, oignons et fromage", ef: "0.56" },
  { nom: "Falafel ou Boulette de pois-chiche et/ou fève, frite", ef: "0.15" },
  ...
  { nom: "Crêpe ou Galette fourrée béchamel champignon, cuite", ef: "0.52" },
  ...
  { nom: "Gratin de légumes en sauce blanche type béchamel, cuit", ef: "0.18" },
  ...
  { nom: "Salade de pomme de terre à la piémontaise, préemballée", ef: "0.45" },
  { nom: "Museau de boeuf en vinaigrette", ef: "2.22" },
  { nom: "Salade de riz", ef: "0.20" },
  { nom: "Salade de pâtes, végétarienne", ef: "0.30" },
  { nom: "Salade de pâtes aux légumes, avec poisson ou viande", ef: "0.43" },
  ...
  { nom: "Lasagnes ou cannelloni au fromage et aux épinards", ef: "0.45" },
  { nom: "Soupe aux lentilles, préemballée à réchauffer", ef: "0.08" },
  {
    nom: "Soupe à la volaille et aux légumes, préemballée à réchauffer",
    ef: "0.01",
  },
  { nom: "Soupe aux légumes variés, préemballée à réchauffer", ef: "0.09" },
  {
    nom: "Soupe de poissons et / ou crustacés, préemballée à réchauffer",
    ef: "1.24",
  },
  { nom: "Soupe aux légumes variés, déshydratée reconstituée", ef: "0.12" },
  {
  ...
  { nom: "Soupe asiatique, avec pâtes, déshydratée reconstituée", ef: "0.30" },
  ...
  { nom: "Soupe asiatique, avec pâtes, préemballée à réchauffer", ef: "0.27" },
  ...
  { nom: "Soupe aux légumes verts, préemballée à réchauffer", ef: "0.08" },
  { nom: "Soupe aux légumes verts, déshydratée reconstituée", ef: "0.10" },
  ...
  { nom: "Anchois, filets à l'huile, semi-conserve, égoutté", ef: "0.26" },
  ...
  { nom: "Roussette ou petite roussette ou saumonette, cuite", ef: "2.31" },
  ...
  { nom: "Roussette ou petite roussette ou saumonette, crue", ef: "1.87" },
  ...
  { nom: "Maquereau, filet sauce tomate, appertisé, égoutté", ef: "0.48" },
  ...
  { nom: "Maquereau, filet sauce moutarde, appertisé, égoutté", ef: "0.48" },
  { nom: "Maquereau, filet au vin blanc, appertisé, égoutté", ef: "0.48" },
  ...
  { nom: "Maquereau espagnol ou maquereau blanc ou billard, cru", ef: "0.29" },
  ...
  { nom: "Joëls (petits poissons entiers) pour friture, crus", ef: "0.16" },
  ...
  { nom: "Salade de chou ou Coleslaw, avec sauce, préemballée", ef: "0.17" },
  ...
  { nom: "Taboulé ou Salade de couscous au poulet, préemballé", ef: "0.29" },
  ...
  { nom: "Porc, palette, découennée, dégraisssée, désossée, crue", ef: "1.46" },
  ...
  { nom: "Jambon de porc à cuire ou Jambon à rôtir/cuire au four", ef: "0.95" },
  ...
  { nom: "Épaule de porc, cuite, choix, découennée dégraissée", ef: "0.95" },
  ...
  { nom: "Épaule de porc, cuite, standard, découennée dégraissée", ef: "0.95" },
  { nom: "Jambon cuit, de Paris, découenné dégraissé", ef: "0.95" },
  { nom: "Haché de volaille", ef: "1.11" },
  { nom: "Dés, allumettes, râpé ou haché de jambon de volaille", ef: "0.82" },
  ...
  { nom: "Chorizo", ef: "0.87" },
  { nom: "Chorizo supérieur, doux ou fort, type saucisse sèche", ef: "0.84" },
  {
  ...
  { nom: "Miel", ef: "0.26" },
  { nom: "Chocolat au lait aux céréales croustillantes, tablette", ef: "1.28" },
  ...
  { nom: "Barre goûter frais au lait et chocolat avec génoise", ef: "0.67" },
  {
    nom:
  ...
  { nom: "Poulet, cuisse, viande et peau, rôtie/cuite au four", ef: "1.13" },
  ...
  { nom: "Poulet, cuisse, viande et peau, bouilli/cuit à l'eau", ef: "1.13" },
  { nom: "Poulet, poitrine, viande et peau, rôti/cuit au four", ef: "1.11" },
  ...
  { nom: "Biscuit apéritif soufflé, à base de pomme de terre", ef: "0.26" },
  ...
  { nom: "Crêpe dentelle (pour apéritif) au fromage, préemballée", ef: "0.26" },
  {
  ...
  { nom: "Glace ou crème glacée, bâtonnet, enrobé de chocolat", ef: "0.28" },
  ...
  { nom: "Coupe glacée parfum pêche Melba ou poire Belle-Hélène", ef: "0.28" },
  ...
  { nom: "Eau de source Cristaline, embouteillée, non gazeuse", ef: "0.03" },
  {
    nom:
...
class Food extends React.Component {
  render() {
    return (
      <div className="food">
        {food.map((prop) => (
          <Card key={prop.nom} value={prop.nom} result={prop.ef} />
        ))}
      </div>
    );
  }
