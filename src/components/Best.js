...
const facts = [
...

  {
    ...
    source:
      "https://blogs.worldbank.org/fr/opendata/graphique-70-de-l-eau-douce-est-utilisee-pour-l-agriculture#:~:text=Dans%20la%20plupart%20des%20r%C3%A9gions,pr%C3%A9l%C3%A8vements%20de%20ressources%20en%20eau.",
    icon: `${water}`,
  },
...

  {
    ...
    source:
      "https://www.socialter.fr/article/maxime-de-rostolan-l-agriculture-industrielle-coute-bien-plus-cher-a-la-societe-que-le-bio-3#:~:text=Dans%20les%20ann%C3%A9es%2040%2C%20avec,g%C3%A9n%C3%A9rer%20une%20seule%20calorie%20alimentaire",
    icon: `${oil}`,
  },

  {
    ...
    source:
      "https://www.planetoscope.com/sols/47-consommation-de-pesticides-phytosanitaires-en-france.html#:~:text=Plus%20de%2066.600%20tonnes%20pesticides,)%20chaque%20seconde%20(compteur",
    icon: `${pesticide}`,
  },
];
